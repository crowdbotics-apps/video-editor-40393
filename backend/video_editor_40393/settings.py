"""
Django settings for video_editor_40393 project.
...
ROOT_URLCONF = 'video_editor_40393.urls'
...
WSGI_APPLICATION = 'video_editor_40393.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "video_editor_40393 API",
    "DESCRIPTION": "API documentation for video_editor_40393 App",
    "VERSION": "v1",
}
